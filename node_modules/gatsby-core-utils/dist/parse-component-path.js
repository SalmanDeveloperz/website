...
const getPathToLayoutComponent = componentPath => splitComponentPath(componentPath)[0]; // Get the path to the content file, falling back to the js component if no content file is given.
