...
var _excluded = ["disableVendorPrefixes"];
...
exports.pluginOptionsSchema = function (_ref) {
  ...
  return Joi.object({
    ...
    disableVendorPrefixes: Joi.boolean().default(false).description("Disables vendor prefixing")
  });
};
...
exports.onCreateBabelConfig = function (_ref2, pluginOptions) {
  ...
  var _ = pluginOptions.disableVendorPrefixes,
      babelOptions = (0, _objectWithoutPropertiesLoose2.default)(pluginOptions, _excluded);
  actions.setBabelPlugin({
    name: "babel-plugin-styled-components",
    stage: stage,
    options: (0, _extends2.default)({}, babelOptions, {
      ssr: ssr
    })
  });
};