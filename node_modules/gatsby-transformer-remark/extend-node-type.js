...
module.exports = function remarkExtendNodeType({
  ...
  return new Promise((resolve, reject) => {
    ...
    for (const plugin of pluginOptions.plugins) {
      const requiredPlugin = "" === `4` ? plugin.module : require(plugin.resolve);
    ...
    async function parseString(string, markdownNode) {
      ...
      for (const plugin of pluginOptions.plugins) {
        const requiredPlugin = "" === `4` ? plugin.module : require(plugin.resolve); // Allow both exports = function(), and exports.default = function()
